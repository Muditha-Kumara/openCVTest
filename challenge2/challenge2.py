...
# --- Create window and trackbars for edge detection ---
...
while True:
    # --- Main loop: edge detection and geometric overlays ---
    ...
    # --- Find intersection points for horizontal lines ---
    # Rightmost edge
    if 0 <= 100 < h:
        row = edges[100]
